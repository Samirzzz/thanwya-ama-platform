...
<div class="main--container">
            ...
            <div class="cards">
                ...
                <div class="card card-2">
                    ...
                    <h3 class="card--value"><?php $sql = "SELECT * from center";
                    if ($result = mysqli_query($conn, $sql)) {
                ...
                <div class="card card-3">
                    ...
                    <h3 class="card--value"><?php $sql = "SELECT * from sessions";
                    if ($result = mysqli_query($conn, $sql)) {
            ...
            <div class="table">
                <div class="section--title">
                    <h3 class="title">Recent Centers</h3>
                    <div></div>
                </div>
                <table>
                    <thead>
                    ...
                    <tbody>
                            <?php 
$sql = "SELECT * FROM user_acc WHERE usertype_id = 3";
