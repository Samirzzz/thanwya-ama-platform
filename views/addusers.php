...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $email = htmlspecialchars($_POST["email"]);
    ...
    if ($result_user_acc) {
        ...
        if ($type == 'student') {
            $sql_student = "INSERT INTO student (firstname, lastname, uid) VALUES ('$firstname', '$lastname', $last_uid)";
            $result_student = mysqli_query($conn, $sql_student);

            if (!$result_student) {
                echo "Error inserting data into the student table: " . mysqli_error($conn);
            }
        } elseif ($type == 'teacher') {
