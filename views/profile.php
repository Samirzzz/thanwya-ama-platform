...
<body>
    <div class="container">
        ...
        if ($_SESSION["type"] === 'student') {
            ...
            echo "<p>Email: <br>" . $_SESSION["email"] . "</p>";
            echo "<p>Phone: <br>" . $_SESSION["number"] . "</p>";
            echo "<p>Specialization: <br>" . $_SESSION["subject"] . "</p>";
            echo "<p>Education: <br> " . $_SESSION["educ"] . "</p>";
        } elseif ($_SESSION["type"] === 'center') {
            echo "<p>Center Name: <br>" . $_SESSION["cname"] . "</p>";
            echo "<p>Center Location: <br> " . $_SESSION["cloc"] . "</p>";
            echo "<p>Center Number: <br> " . $_SESSION["cnumber"] . "</p>";
        }
        ?>
